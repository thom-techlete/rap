...
class BugReport(models.Model):
    ...
    title = models.CharField(
        max_length=200, verbose_name="Titel", help_text="Korte beschrijving van de bug"
    )
    ...
    reported_at = models.DateTimeField(
        default=timezone.now, verbose_name="Gerapporteerd op"
    )
    ...
    resolved_at = models.DateTimeField(
        null=True, blank=True, verbose_name="Opgelost op"
    )
