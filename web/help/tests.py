...
class BugReportModelTest(TestCase):
    ...
    def test_bug_report_creation(self):
        ...
        bug_report = BugReport.objects.create(
            title="Test Bug", description="This is a test bug", reported_by=self.user
        )
...
class BugReportViewTest(TestCase):
    ...
    def test_bug_detail_view_user_access(self):
        ...
        response = self.client.get(
            reverse("help:bug_detail", kwargs={"pk": self.bug_report.pk})
        )
    ...
    def test_admin_bug_detail_view_staff_access(self):
        ...
        self.client.login(username="staffuser", password="staffpass123")
        response = self.client.get(
            reverse("help:admin_bug_detail", kwargs={"pk": self.bug_report.pk})
        )
    ...
    def test_admin_bug_mark_resolved(self):
        ...
        self.client.login(username="staffuser", password="staffpass123")
        response = self.client.post(
            reverse("help:admin_bug_mark_resolved", kwargs={"pk": self.bug_report.pk})
        )
    ...
    def test_admin_bug_mark_closed(self):
        ...
        self.client.login(username="staffuser", password="staffpass123")
        response = self.client.post(
            reverse("help:admin_bug_mark_closed", kwargs={"pk": self.bug_report.pk})
        )
