...
urlpatterns = [
    ...
    path(
        "admin/bug/<int:pk>/resolve/",
        views.admin_bug_mark_resolved,
        name="admin_bug_mark_resolved",
    ),
    path(
        "admin/bug/<int:pk>/close/",
        views.admin_bug_mark_closed,
        name="admin_bug_mark_closed",
    ),
]
