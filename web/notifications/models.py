...
class PushSubscription(models.Model):
    ...
    endpoint = models.URLField(
        max_length=500, verbose_name="Endpoint", help_text="Push service endpoint URL"
    )
    p256dh_key = models.TextField(
        verbose_name="P256DH Key", help_text="Public key for encryption"
    )
    auth_key = models.TextField(
        verbose_name="Auth Key", help_text="Authentication secret"
    )
    ...
    is_active = models.BooleanField(
        default=True, verbose_name="Actief", help_text="Of deze subscription actief is"
    )
...
class PushNotificationLog(models.Model):
    ...
    icon = models.CharField(max_length=200, blank=True, verbose_name="Icoon")

    # Sending details
    sent_at = models.DateTimeField(auto_now_add=True)
    success = models.BooleanField(default=False, verbose_name="Succesvol")
    error_message = models.TextField(blank=True, verbose_name="Foutmelding")
    response_code = models.IntegerField(
        null=True, blank=True, verbose_name="Response Code"
    )
