...
class ScheduleConfiguration(models.Model):
    ...
    TASK_CHOICES = [
        ("notifications.tasks.send_automatic_event_reminders", "Automatische evenement herinneringen"),
        ("notifications.tasks.cleanup_old_reminder_logs", "Opruimen oude herinnering logs"),
    ]
    ...
    def clean(self):
        ...
        if "reminder" in self.task and not self.reminder_type:
            raise ValidationError("Herinnering taken moeten een herinnering type hebben")
...
class EventScheduleOverride(models.Model):
    ...
    def get_effective_schedule(self):
        ...
        return {
            ...
            "day_of_month": self.override_day_of_month or self.configuration.day_of_month,
            "month_of_year": self.override_month_of_year or self.configuration.month_of_year,
        }
