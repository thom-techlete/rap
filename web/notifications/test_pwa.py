...
from notifications.models import PushNotificationLog, PushSubscription
...
class PushNotificationTestCase(TestCase):
    ...
    def test_push_subscription_creation(self):
        ...
        self.assertEqual(
            subscription.endpoint, "https://fcm.googleapis.com/fcm/send/test-endpoint"
        )
    ...
    def test_push_subscription_delete(self):
        ...
        delete_data = {"endpoint": "https://fcm.googleapis.com/fcm/send/test-endpoint"}
...
class PushNotificationModelTestCase(TestCase):
    ...
    def test_push_subscription_creation(self):
        ...
        self.assertEqual(
            str(subscription),
            f"Push subscription voor {self.user.get_full_name()} (https://fcm.googleapis.com/fcm/send/test-endpoint...)",
        )
        ...
        self.assertEqual(
            info["endpoint"], "https://fcm.googleapis.com/fcm/send/test-endpoint"
        )
    ...
    def test_push_notification_log_creation(self):
        ...
        self.assertEqual(
            str(log), f"✓ Test Notification naar {self.user.get_full_name()}"
        )
