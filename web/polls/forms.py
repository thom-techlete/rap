...
class PollForm(forms.ModelForm):
    ...
    class Meta:
        model = Poll
        fields = ["title", "description", "allow_multiple_choices", "end_date"]
        widgets = {
            ...
            "allow_multiple_choices": forms.CheckboxInput(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["allow_multiple_choices"].help_text = (
            "Kunnen spelers meerdere opties kiezen?"
        )
        self.fields["end_date"].help_text = (
            "Optionele einddatum (laat leeg voor handmatig sluiten)"
        )
    ...
    class Meta:
        ...
        widgets = {
            "text": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Voer optie tekst in..."}
            ),
        }
