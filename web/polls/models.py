...
class Poll(models.Model):
    ...
    title = models.CharField(
        max_length=200, verbose_name="Titel", help_text="Titel van de poll"
    )
    ...
    closed_at = models.DateTimeField(null=True, blank=True, verbose_name="Gesloten op")
    ...
    def unique_voters(self):
        ...
        return (
            Vote.objects.filter(poll_option__poll=self)
            .values("user")
            .distinct()
            .count()
        )
...
class PollOption(models.Model):
    ...
    poll = models.ForeignKey(
        Poll, on_delete=models.CASCADE, related_name="options", verbose_name="Poll"
    )
...
class Vote(models.Model):
    ...
    voted_at = models.DateTimeField(default=timezone.now, verbose_name="Gestemd op")
