    ...
    def handle(self, *args, **options):
        ...
        polls_data = [
            ...
            },
            {
                ...
                "options": ["Blauw/Wit", "Rood/Zwart", "Groen/Wit", "Oranje/Blauw"],
            },
        ]
        ...
        for poll_data in polls_data:
            ...
            poll, poll_created = Poll.objects.get_or_create(
                ...
                defaults={**poll_data, "created_by": staff_user},
            )
            ...
            if poll_created:
                ...
                for i, option_text in enumerate(options_data):
                    option = PollOption.objects.create(
                        poll=poll, text=option_text, order=i
                    )
        ...
        if options["with_votes"] and created_polls:
            ...
            for poll in created_polls:
                ...
                num_voters = random.randint(
                    int(len(active_players) * 0.3), int(len(active_players) * 0.8)
                )
                ...
                for voter in voters:
                    ...
                    for option in chosen_options:
                        Vote.objects.get_or_create(user=voter, poll_option=option)
